...
//	@SuppressWarnings("null")
	...
	public List<Wholesaler_Product> getWholesalerItemList(int id) {
		...
		List<Wholesaler_Product> itemlist = new ArrayList<>();
...
//		throw new UserHandlingException("Please Enter a Valid Item Id");
	...
	@Override
	public Wholesaler_Product updateQuantity(int id, int quantity, int userid) {
...
//		throw new UserHandlingException("Please Enter a Valid Item Id");
	...
	public List<Wholesaler_Product> getWholesalerList(int proid) {
		...
		List<Wholesaler_Product> list = itemss.findByProductId(proid);
